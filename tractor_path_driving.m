...
%% Create QUEUE Object
% Sensor Data
delayed_snr_PosX = QUEUE(1000);     delayed_snr_PosY = QUEUE(1000);
delayed_snr_Head = QUEUE(1000);     delayed_snr_Speed = QUEUE(1000);

% Actuator Data
delayed_act_Steer = QUEUE(10000);
delayed_act_Speed = QUEUE(10000);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% User can change the delay constants
delay_snr_PosX = 0.0;   delay_snr_PosY = 0.0;
delay_snr_Head = 0.0;   delay_snr_Speed = 0.0;

...
classdef CAR_AUTO_STEER
    ...
    methods (Access = private)
        function obj = setup_path(obj)
            ...
            obj.WayPointX(1,1) = 100.0;  obj.WayPointY(1,1) = 0.0;       obj.WaySpeedKmh(1,1) = 2.0;
            obj.WayPointX(1,2) = 0.0;   obj.WayPointY(1,2) = 10;         obj.WaySpeedKmh(1,2) = 2.0;
            obj.WayPointX(1,3) = 100;    obj.WayPointY(1,3) = 10;         obj.WaySpeedKmh(1,3) = 2.0;
            obj.WayPointX(1,4) = 0.0;   obj.WayPointY(1,4) = 20;        obj.WaySpeedKmh(1,4) = 2.0;
